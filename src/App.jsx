    ...
    <>
      ...
      <div className="app">
        ...
        {editP&&<EditModal player={editP} onSave={handleEditSave} onClose={()=>setEditP(null)}/>}
            ...
            <div style={{width:"36px",height:"36px",borderRadius:"8px",background:"var(--gold)",display:"flex",alignItems:"center",justifyContent:"center",fontWeight:900,fontSize:"14px",color:"var(--bg)",fontFamily:"Arial Black"}}>SR</div>
            <div>
              <div className="logo">SCOUT<span>ROOM</span></div>
              <div style={{fontSize:"10px",color:"var(--muted)",letterSpacing:"1px",fontWeight:500,marginTop:"-2px"}}>ANDORRE D2 · ÉTÉ 2026</div>
            </div>
          </div>t { useState, useEffect, useCallback } from "react";
