...
export default function App(){
  ...
  if(authLoading) return <><style dangerouslySetInnerHTML={{__html:css}}/><div style={{minHeight:'100vh',background:'var(--bg)',display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column',gap:16}}><img src="/logo.png" style={{width:64,height:64,borderRadius:12,animation:'pulse 1.5s ease-in-out infinite'}}/><div style={{color:'var(--muted)',fontSize:12,letterSpacing:2}}>CHARGEMENT...</div></div></>;
