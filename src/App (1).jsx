...
@media(max-width:768px){
  ...
  .topbar{height:auto;flex-direction:column;align-items:stretch;padding:10px 14px 0;gap:0;position:sticky;top:0;z-index:200}
  .tabs{display:flex;overflow-x:auto;gap:0;-webkit-overflow-scrolling:touch;scrollbar-width:none;border-top:1px solid var(--border);margin:0 -14px;padding:0 6px}
  .tabs::-webkit-scrollbar{display:none}
  .tab{font-size:10px;padding:10px 10px;white-space:nowrap;flex-shrink:0;border-radius:0;border-bottom:2px solid transparent}
...
export default function App(){
  ...
  const getHashTab=()=>{const h=window.location.hash.replace('#','');const v=['dashboard','effectif','cibles','analyser','budget','guide','profil','admin'];return v.includes(h)?h:'dashboard';};
